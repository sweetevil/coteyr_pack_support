  ...
  namespace :convert do
    ...
    def convert_directory_format(to_format)
      model_class.find(:all).each do |obj|
        ...
        flat_path   = "#{Rails.root.to_s}/#{model_class.image_directory}/#{obj.id}.#{model_class.image_storage_format}"
        nested_path = "#{Rails.root.to_s}/#{model_class.image_directory}/#{creation.year}/#{creation.month}/#{creation.day}/#{obj.id}.#{model_class.image_storage_format}"
