...
require File.dirname(__FILE__) + '/lib/exception_notifier/exception_notifier.rb'
require File.dirname(__FILE__) + '/lib/exception_notifier/exception_notifiable.rb'
require File.dirname(__FILE__) + '/lib/exception_notifier/exception_notifier_helper.rb'
